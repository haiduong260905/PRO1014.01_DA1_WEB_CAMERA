                ...
                <div id="cssmenu">
                    <ul>
                        ...
                        <li class="has-sub"><a href="#">Giá bán</a>
                            <ul>
                                <li><span class="checkbox-list">Trên 100 Triệu</span></li>
                                <li><span class="checkbox-list">Trên 20 Triệu</span></li>
                                <li><span class="checkbox-list">Trên 10 Triệu</span></li>
                                <li><span class="checkbox-list">Trên 50 Triệu</span></li>
                                <li><span class="checkbox-list">Trên 5 Triệu</span></li>
                            </ul>
                        </li>
                    </ul>
                </div>
